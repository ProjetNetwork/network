...
use HomeBundle\Entity\Evenement;
use HomeBundle\Form\EvenementType;
...
class EvenementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $evenements = $em->getRepository('HomeBundle:Evenement')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('HomeBundle\Form\EvenementType', $evenement);
    ...
    {
        $deleteForm = $this->createDeleteForm($evenement);
        $editForm = $this->createForm('HomeBundle\Form\EvenementType', $evenement);
